...
export const events: BEvent[] = [
  {
    ...
    format: "In person",
    bestFor: "New",
    outcome: "You'll leave able to name the one workflow worth changing first.",
    bring: "One recurring workflow that frustrates your team.",
    leaveWith: "A short list of candidate first-win workflows and a next step.",
    agenda: [
      "Where AI is showing up in Peel businesses",
      "Three questions to sort useful from noisy",
  ...
  },
  {
    ...
    outcome: "Pressure-test whether quote drafting is a defensible first proof.",
    bring: "A recent quote, your pricing rules, and the person who reviews quotes today.",
    leaveWith: "A completed use-case brief and a go/no-go recommendation.",
    agenda: [
      "Use-case brief walkthrough",
  ...
  },
  {
    ...
    bring: "Your candidate workflow, expected value, and any vendor conversations to date.",
    leaveWith: "A signed decision sheet with an owner and review date.",
    agenda: [
      "Route criteria",
  ...
  },
  {
    ...
    bestFor: "All",
    outcome:
      "Hear three operators describe experiments that worked and experiments that were retired.",
    bring: "One question you would ask an operator further down the route.",
    leaveWith: "Notes and contacts for follow-up conversations.",
    agenda: [
