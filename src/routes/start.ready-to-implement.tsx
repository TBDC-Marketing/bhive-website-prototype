...
const route = [
  "Deep intake: systems, data, constraints, success criteria.",
  "Readiness and security audit.",
  "Buy/build decision against the same criteria.",
  "Controlled proof on representative data.",
  "User acceptance on real tasks.",
  "Sign the rollout: price, owner, controls, review schedule.",
];
  ...
  return (
    <>
      <PageHero
        ...
        lede="Pressure-test the use case, data, security, and delivery route. Prove it with real users before you commit."
        ctas={<>
        ...
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-7">
            <ul className="space-y-3 text-lg">
              {[
                "the problem and executive sponsor are clear;",
                "budget or a buying window is active;",
                "the use case touches core systems or sensitive data;",
                "you need a neutral route to a defendable decision.",
      ...
      <Section bg="ink">
        <Reveal>
          ...
          <h2 className="mt-4 max-w-4xl font-display text-3xl md:text-4xl text-paper">
            It is a <em className="text-honey not-italic">production candidate</em>, not "production-ready," until it passes your security, support, and acceptance gates.
          </h2>
          <p className="mt-6 max-w-2xl text-paper/70">
            BNext helps define and test the gates. You make the call.
          </p>
        </Reveal>
      </Section>
